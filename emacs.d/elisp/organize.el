...
;; (defun lefv/org-babel-tangle-config ()
;;   "Auto tangle."
;;   (when (string-equal (buffer-file-name)
;;                       (expand-file-name "~/workspace/development/lefv/dotfiles/config/emacs_config.org"))
;;     ;; Dynamic scoping to the rescue
;;     (let ((org-confirm-babel-evaluate nil))
;;       (org-babel-tangle))))

;; (add-hook 'org-mode-hook (lambda () (add-hook 'after-save-hook #'lefv/org-babel-tangle-config)))
